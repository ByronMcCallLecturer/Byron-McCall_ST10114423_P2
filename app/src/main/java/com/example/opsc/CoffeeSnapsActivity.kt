...
import com.example.opsc.databinding.ActivityCoffeeSnapsBinding
...
class CoffeeSnapsActivity : AppCompatActivity() {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        // When fab is clicked, it creates an OutputFileOptions object to specify the file where the
            ...
            imageCapture?.takePicture(outputFileOptions, imgCaptureExecutor,
                object: ImageCapture.OnImageSavedCallback {
                    ...
                    override fun onImageSaved(outputFileResults: ImageCapture.OutputFileResults) {
                        ...
                        this@CoffeeSnapsActivity.runOnUiThread{ binding.imgSavedPhoto.setImageURI(outputFileResults.savedUri)
                        }
                    }
                })
        }
